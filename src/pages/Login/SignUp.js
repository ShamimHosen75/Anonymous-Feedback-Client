                ...
                <div className="hero-content pt-3 pb-10">
                    <div style={{ boxShadow: "0 3px 8px rgb(0 0 0 / 24%)" }} className="card flex-shrink-0 w-full max-w-sm bg-base-100">
                        <div className="card-body py-4">
                            <h4 className='text-3xl text-center text-secondary font-bold'>Register</h4>
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="form-control mt-2">
                                    <input type="submit" value="Sign Up" className="btn btn-primary border-0 text-secondary font-bold"></input>
                                </div>
